...
const ProjectCard = styled.div`
  ...
  } // close project header information
        ...
        <h3>{node.frontmatter.name}</h3>
          <div>
            ...
            <a href={node.frontmatter.production} target="_blank" rel="noopener noreferrer">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M17 2H22V7" stroke="#000" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path><path d="M21 13V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3H11" stroke="#000" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"></path><path d="M13 11L21.5 2.5" stroke="#000" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"></path></svg>
            </a>
          </div>
        </div>
