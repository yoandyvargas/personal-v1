...
const Hero = () => {
  ...
  return (
    <StyledHero>
      ...
      <ButtonList>
        <Button href="https://github.com/yoandyvargas" target="_blank" rel="noopener noreferrer">
        ...
        <Button href="https://www.linkedin.com/in/yoandyvargas/" target="_blank" rel="noopener noreferrer">
